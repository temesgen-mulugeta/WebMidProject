                ...
                <div class="card-body">
                    ...
                    <div>
                        ...
                        <form id="form2" runat="server">
                            ...
                            <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator4" runat="server" ErrorMessage="Password cannot be blank" ControlToValidate="LoginPasswordTB" ForeColor="Red">
                            </asp:RequiredFieldValidator>
