...
<html lang="en" dir="ltr"  >
  ...
  <div class="card-body">
      ...
      <form id="form2" runat="server">
          ...
          <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator2" runat="server" ErrorMessage="Email cannot be blank" ControlToValidate="LoginEmailTB" ForeColor="Red"></asp:RequiredFieldValidator>  
            <asp:RegularExpressionValidator  Display="Dynamic" ID="RegularExpressionValidator1" runat="server" ControlToValidate="LoginEmailTB" ErrorMessage="Incorrect format" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator> 
          <br />
          <p class="label">
              PASSWORD</p>
          ...
          <asp:RegularExpressionValidator  Display="Dynamic" ID="RegularExpressionValidator3" runat="server" ControlToValidate="LoginPasswordTB" ErrorMessage="Password must contain 8-15 characters" ForeColor="Red" ValidationExpression="^(?=.*[A-Za-z0-9])(?=.*\d)[A-Za-z0-9\d]{8,15}"></asp:RegularExpressionValidator> 
